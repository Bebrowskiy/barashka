...
export const crossfadeSettings = {
    ...
    DEFAULTS: {
        ...
        curve: 'logarithmic', // 'linear', 'logarithmic', 'exponential', 'sine', 'cosine'
        autoCrossfade: true, // Автоматический crossfade при окончании трека
        minDuration: 1000, // Минимальная длительность (1 сек)
        maxDuration: 30000, // Максимальная длительность (30 сек)
    },
    ...
    /**
     * Получить длительность перехода (мс)
     */
    getDuration() {
    ...
    /**
     * Включить/выключить автоматический crossfade
     */
    toggleAutoCrossfade() {
        const current = this.get();
    ...
    /**
     * Получить настройки для экспорта
     */
    export() {
